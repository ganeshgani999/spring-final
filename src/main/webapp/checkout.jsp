...
<html>
    <head>
		...
		<script>
			function toggleRazorpayButton() {
			const paymentMode = document.getElementById("paymentMode").value;
			const razorpayForm = document.getElementById("razorpayForm");
					        
			// Show Razorpay form only if "Online Banking" is selected
			if (paymentMode === "Online Banking") {
                    ...
                    <div>
                        ...
                        <div class="form-group">
							<label>Select Payment Mode</label>
							    <select name="payment" id="paymentMode" style="width: 1135px; height: 40px;" class="form-control" onchange="toggleRazorpayButton()">
                        ...
                        <div>
							...
							<form id="razorpayForm" style="display: none;">
								<!-- Razorpay Payment Button Script embedded within form tag -->
